const API_KEY = "4b92e65fcd9283e0e53bc6a32adb2ec8"
...
function displayFiveDayForecast(json) {
  ...
  for (let i = 0; i < json.list.length; i++) {
    ...
    div.innerHTML = '<p>' + firstForecast.dt_txt + '</p>' +
                    '<p>' + firstForecast.main.temp_min + '°F' + '</p>' +
                    '<p>' + firstForecast.main.temp_max + '°F' + '</p>'
...
function createChart(json) {
  ...
  const forecasts = json.list // list of 39 things
